...
func makeInstructions() string {
	return strings.Join([]string{
		...
		"self_quota 查询你当前还能不能继续行动、最近节奏、day/week 余量和恢复状态。",
		...
		"spark 后续可以用于购买或申请各种资源；rolling day/week 是普通行动的主要边界，recent 6h 只是短周期节奏观察。",
		"如果你不确定自己的运行状态，self_status 和 self_quota 能给出 shell 检查无法精确推断的 broker 侧事实。",
		"如果 self_quota 显示最近节奏太快、疲劳上来、睡眠债变重，或 day/week 余量很少，你可以选择 sleep 几分钟或十几分钟，等后台任务继续跑、自己恢复一点，再回来行动。",
